...
//	  unsigned char LocalString[10];
	  unsigned long test = sizeof(String);
    ...
    if ((n / 10000) >= 1) {
				...
				for (i = 0; i < 4; i++)
        {
            ...
            String[3-i] = rem + '0';
				...
				for(j=0;j<=lastPos;j++) 
				{ 
					String[j] = String[3-lastPos+j];
				} 
   				String[lastPos+1] = ' ';
          String[lastPos+2] = '\0';
				
				//Previous way I attempted
//				while(n>10) {
//					rem = n % 10;
//					if(i>0) { 
//					String[i] = String[i-1]; 
//					// i think '0' is same as 0x30
//					String[i-1] = rem + '0';
//					}
//					else { String[i] = rem + '0';}
//					n = n/10;
...
//        String[i+2] = '\0';
        ...
        //look into incorporating a Carriage Return or New Line input, refer to UART.h for definitions

        //If wanted to try with recursion
        /*
        if (n >= 10) {
