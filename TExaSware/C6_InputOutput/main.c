...
int main(void){    // initialize PF0 and PF4 and make them inputs
  ...
  while(1){
    ...
    In = In>>2;                    // shift into position PF2
		...
		// the & here clears PF2 0xFB mask equals 11111011 before setting it
		Out = Out&0xFB;
		// the OR here sets the PF2 bit to 1, since In was shifted over into the PF2 position
		// In PF2 here is a 1 and Out PF2 is a 0 from previous clear command. New Out will now have a 1 at PF2
		Out = Out|In;
		//assigns value of port to value of out
